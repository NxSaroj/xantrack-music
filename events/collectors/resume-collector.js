    ...
    if (interaction.customId == "resume") {
      ...
      try {
        const resumeEmbed = new EmbedBuilder()
          .setColor("D100FF")
          .setDescription(
            "<a:xn_pink_tick:1215931955737133066> **Resumed the player for you**"
          );
        ...
        const errorEmbed = new EmbedBuilder()
          .setDescription(
            `> <:xn_pink_wrong:1215934948075110441> **Oops! Looks like the queue has been playing already **<a:xn_pink_hearts:1215934746316767352>`
          )
          .setColor("D100FF");
